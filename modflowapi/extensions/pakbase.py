...
class Package:
    ...
    def get_advanced_var(self, name):
        ...
        if not self._sim_package and isinstance(self, ArrayPackage):
...
#
# These are behaviorally identical to Package and exist only so that
# isinstance(pkg, ArrayPackage) etc. still resolves as it did pre-refactor.
# They are deprecated and will be removed, along with the isinstance-based
# type dispatch they support, in a future release.
# ------------------------------------------------------------------


def _warn_deprecated_package_class(name):
    warnings.warn(
        f"{name} is deprecated and will be removed in a future release; use Package instead.",
        DeprecationWarning,
        stacklevel=3,
    )
...
class PackageBase(Package):
    def __init__(self, *args, **kwargs):
        _warn_deprecated_package_class("PackageBase")
        super().__init__(*args, **kwargs)


class ListPackage(Package):
    def __init__(self, *args, **kwargs):
        _warn_deprecated_package_class("ListPackage")
        super().__init__(*args, **kwargs)


class ArrayPackage(Package):
    def __init__(self, *args, **kwargs):
        _warn_deprecated_package_class("ArrayPackage")
        super().__init__(*args, **kwargs)


class ScalarPackage(Package):
    def __init__(self, *args, **kwargs):
        _warn_deprecated_package_class("ScalarPackage")
        super().__init__(*args, **kwargs)


class AdvancedPackage(Package):
    def __init__(self, *args, **kwargs):
        _warn_deprecated_package_class("AdvancedPackage")
        super().__init__(*args, **kwargs)
